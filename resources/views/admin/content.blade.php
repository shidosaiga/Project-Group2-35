                ...
                @foreach($content as $contents)
                  <tr>
                    ...
                    <td> <div class="categories-table-img">
                      <img src="{{ asset('/admin/img/Mecha/'.$contents->image) }} ">
                    </div>
                  </td>
                    ...
                    <td>
                           <h3 style="color:green"><a href="{{url('admin/edit/editcontent/edit/'.$contents->id)}}">Edit</a></h3>
                           <h3 style="color:red;"><a href="{{url('admin/edit/editcontent/del/'.$contents->id)}}">Delete</a></h3> 
                    </td>
                  </tr>
                  @endforeach
                  <!-- <tr>
