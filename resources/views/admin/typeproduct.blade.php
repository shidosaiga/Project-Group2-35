    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="active" href="{{route('typeproduct')}}">
...
<main class="main users chart-page" id="skip-target">
      <div class="container">
        <h1 class="main-title">Typeproduct</h1>
        <button class="btn-2" ><a href="{{route('addtypeproduct')}}">Add new</a></button>
              ...
              <table class="posts-table">
               ...
               @foreach($typeproduct as $typeproduct)
                  <tr>
                    ...
                    <td>
                          <li style="color:green"><a href="{{url('admin/edit/editypetproduct/edit/'.$typeproduct->id)}}">Edit</a></li>
                          <li style="color:red;"><a href="{{url('admin/edit/editypetproduct/del/'.$typeproduct->id)}}">Delete</a></li>                        
                    ...
                    <td>
                      <span class="p-relative">
                        ...
                        <ul class="users-item-dropdown dropdown">
                          <li><a href="{{route('edittypeproduct')}}">Edit</a></li>
