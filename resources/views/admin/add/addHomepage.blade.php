          ...
          <div class="col-lg-9">
            ...
            <div class="users-table table-wrapper">
              <table class="posts-table">
                ...
                <tbody>
                <form action="{{route('addhomepage.create')}}" method="post">
                  @csrf
                  <tr>
                      <td>
                     ...
                     <div class="form-group">
                       <input type="text" class="form-control" name="text" id="text" placeholder="test">
                     </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td> 
                     <div class="form-group">
                      <input type="file" class="form-control"  name="popular" id="popular" required>
                  </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td> 
                     <div class="form-group">
                       <input type="file" class="form-control"  name="promotion" id="promotion" required>
                    </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td> 
                     <div class="form-group">
                     <input type="text" class="form-control" name="productname" id="productname" placeholder="Test name product">
                    </div>
                     </td>
                  </tr>
