              ...
              <table class="posts-table">
                <thead>
                  <tr class="users-table-info">
                    ...
                    <th>Add Typeproduct</th>
                    
                  </tr>
                </thead>
                <tbody>
                <form action="{{route('addtypeproduct.create')}}" method="post" >
                  @csrf
                  <tr>
                     <td> 
                        <div class="form-group">
                          <label for="name">Name</label>
                          <input type="name" class="form-control" name="name" id="name" placeholder="Type Product Name">
                        </div>
                     </td>
               </td>
