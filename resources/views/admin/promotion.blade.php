  ...
  <aside class="sidebar">
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            ...
            <ul class="sidebar-body-menu">
                <li>
                    <a class="active" href="{{route('promotion')}}"><span class="icon edit" aria-hidden="true"></span>Promotion</a>
                </li>
                <li>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
  ...
  <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h1 class="main-title">Promotion</h1>
        <button class="btn-2" ><a href="{{route('addpromotion')}}">Add new</a></button>
                ...
                @foreach($promotion as $promotions)
                  <tr>
                    ...
                    <td><div class="categories-table-img">
                       <img src="{{ asset('/admin/img/Mecha/'.$promotions->image) }} ">
                      </div>
                    </td>
                    ...
                    <td>
                           <li style="color:green"><a href="{{url('admin/edit/editpromotion/edit/'.$promotions->id)}}">Edit</a></li>
                           <li style="color:red;"><a href="{{url('admin/edit/editpromotion/del/'.$promotions->id)}}">Delete</a></li> 
                    </td>
                  </tr>
                  @endforeach
