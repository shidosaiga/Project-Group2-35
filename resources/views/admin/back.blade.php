    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="active" href="{{route('back')}}">
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
 ...
 <main class="main users chart-page" id="skip-target">
      <div class="container">
        ...
        <button class="btn-2"><a href="{{route('addback')}}">Add new</a></button>
                ...
                @foreach($background as $backgrounds)
                  <tr>
                    ...
                    <td><div class="categories-table-img">
                       <img src="{{ asset('/admin/img/Mecha/'.$backgrounds->image) }} ">
                      </div>
                    </td>
                   
                    <td>{{$backgrounds->	created_at}}</td>
                    <td>{{$backgrounds->	updated_at}}</td>
                    <td>
                           <li style="color:green"><a href="{{url('admin/edit/editbackground/edit/'.$backgrounds->id)}}">Edit</a></li>
                           <li style="color:red;"><a href="{{url('admin/edit/editbackground/del/'.$backgrounds->id)}}">Delete</a></li> 
                    </td>
                  </tr>
                  @endforeach
