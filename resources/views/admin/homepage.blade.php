...
<!-- ! Main -->
 <main class="main users chart-page" id="skip-target">
      <div class="container">
        ...
        <button class="btn-2" ><a href="{{route('addhomepage')}}">Add new</a></button>
              ...
              <table class="posts-table">
                ...
                @foreach($homepage as $homepages)
                  <tr>
                    ...
                    <td>{{$homepages->text}}</td>
                    <td> <div class="categories-table-img">
                      <img src="{{ asset('/admin/img/Mecha/'.$homepages->popular) }} ">
                    </div>
                  </td>
                    <td> <div class="categories-table-img">
                      <img src="{{ asset('/admin/img/Mecha/'.$homepages->promotion) }} ">
                    </div>
                  </td>
                    <td>{{$homepages->productname}}</td>
                    <td> <div class="categories-table-img">
                      <img src="{{ asset('/admin/img/Mecha/'.$homepages->background) }} ">
                    </div>
                  </td>
                    <td>{{$homepages->price}}</td>
                    </div>
                    <td>{{$homepages->created_at}}</td>
                    <td>{{$homepages->updated_at}}</td>
                    <td>
                           <li style="color:green"><a href="{{url('admin/edit/edithomepage/edit/'.$homepages->id)}}">Edit</a></li>
                           <li style="color:red;"><a href="{{url('admin/edit/edithomepage/del/'.$homepages->id)}}">Delete</a></li>                        
                           </td>
                  </tr>
                  @endforeach
