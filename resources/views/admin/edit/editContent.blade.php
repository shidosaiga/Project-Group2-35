    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="active" href="{{route('content')}}">
          ...
          <div class="col-lg-9">
            ...
            <div class="users-table table-wrapper">
              <table class="posts-table">
                ...
                <tbody>
                <form action="{{url('admin/edit/editcontent/update/'.$content->id)}}" method="post" >
                  @csrf
                  <tr>
                    <td><label for="name">Head</label></td>
                     <td> 
                ...
                <tr>
                   ...
                   <td> 
                       <div class="form-group">
                            <input type="file" class="form-control"  name="image" id="image" value ="{{$content->image}}">
                        </div>
                     </td>
                  ...
                  <tr>
                     ...
                     <td> 
                        <div class="form-group">
                             <input type="text" class="form-control" name="description" id="description" placeholder="Text" value ="{{$content->description}}"required>
                        </div>
                     </td>
                  </tr>
                  <tr>
