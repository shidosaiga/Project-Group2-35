          ...
          <div class="col-lg-9">
            ...
            <div class="users-table table-wrapper">
              <table class="posts-table">
                ...
                <tbody>
                <form action="{{url('admin/edit/editbackground/update/'.$background->id)}}" method="post">
                @csrf
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <input type="file" class="form-control"  name="image" id="image" value ="{{$background->image}}">
                        </div>
                    </td>
                </tr>
