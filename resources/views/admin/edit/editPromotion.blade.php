              ...
              <table class="posts-table">
                <thead>
                  <tr class="users-table-info">
                    ...
                    <th>Edit Promotion</th>
                    <th></th>
                    
                  </tr>
                </thead>
                <tbody>
                <form action="{{url('admin/edit/editpromotion/update/'.$promotion->id)}}" method="post" >
                  @csrf
                  <tr>
                      <td>
                     ...
                     <td> 
                        <div class="form-group">
                             <input type="file" class="form-control"  name="image" id="image" value="{{$promotion->image}}"required>
                         </div>
                     </td>
                  </tr>
                  <tr>
