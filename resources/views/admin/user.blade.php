    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a class="active" href="{{route('user')}}">
              ...
              <table class="posts-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                           <li style="color:green"><a href="{{url('admin/edit/edituser/edit/'.$user->id)}}">Edit</a></li>
                           <li style="color:red;"><a href="{{url('admin/edit/edituser/del/'.$user->id)}}">Delete</a></li>                        
                    ...
                    <td>
                      <span class="p-relative">
                        ...
                        <ul class="users-item-dropdown dropdown">
                          <li><a href="{{route('edituser')}}">Edit</a></li>
