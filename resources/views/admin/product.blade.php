    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    <a  class="active" href="{{route('product')}}" ><span class="icon folder" aria-hidden="true"></span>Product 
                    </a>                  
                </li>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        ...
        <button class="btn-2" ><a href="{{ route('addproduct') }}">Add new</a></button>
                ...
                @foreach($products as $product)
                  <tr>
                    ...
                    <td>
                     ...
                     <td><div class="">
                        <img src="{{ asset('/admin/img/Mecha/'.$product->image) }} ">
                      </div>
                    </td>
                    <td>{{$product->name}}</td>
                    ...
                    <td>
                           <li style="color:green"><a href="{{url('admin/edit/editproduct/edit/'.$product->id)}}">Edit</a></li>
                           <li style="color:red;"><a href="{{url('admin/edit/editproduct/del/'.$product->id)}}">Delete</a></li>                        
